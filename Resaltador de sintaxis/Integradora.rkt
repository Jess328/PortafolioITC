...
(define html-head (string-append "<!DOCTYPE html><html lang=\"es\"><head><meta charset=\"UTF-8\"><title>Analizador Lexico</title><link href=\"estilos.css\" rel=\"stylesheet\"></head><body>
" (word-lexer (string-split file-br))))

(define html (string-append html-head "</body></html>"))

(define test (write-file "output.html" html))
