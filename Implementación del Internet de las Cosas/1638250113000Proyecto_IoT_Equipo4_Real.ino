...
#define channelID 1587062 
const char mqttUserName[] = "DCIVOSw9FwMeITAcIzQfBQ0"; 
const char clientID[] = "DCIVOSw9FwMeITAcIzQfBQ0";
const char mqttPass[] = "xUNYVni5GJdP2Ww4WrdXsqyO";
...
void loop() {
  ...
  Serial.print(" *C  ");
  Serial.print("humo: ");
  Serial.println(analogRead(humo)); // Leer sensor MQ2 
  delay(1000); // Print value every 1 sec.

  
    mqttPublish( channelID, (String("field1=")+String(h)) );
     mqttPublish( channelID, (String("field2=")+String(t)) );
      mqttPublish( channelID, (String("field3=")+String(analogRead(humo))) );
